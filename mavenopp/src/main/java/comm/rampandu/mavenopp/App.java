...
public class App 
{
	...
	public static void main( String[] args )
    {
        ...
        gift.add(c1);
        Sweet c2=new Chocolates("dairy-milk","90%", 1,15);
        gift.add(c2);
        Sweet c3=new Candys("lollipop","60%", 2,10);
        gift.add(c3);
        Sweet c4=new Candys("chewing-gum","50%", 8,10);
        gift.add(c4);
        Sweet c5=new Jellybeans("Licorice","30%",5,2);
        gift.add(c5);
        Sweet c6=new Candys("jelly","20%",6,2);
        gift.add(c6);
        ...
        System.out.println("");
        System.out.println("candies between range of the weight in between 2 to 9\n");
        for(int i=0;i<gift.size();i++)
        {
            if(gift.get(i) instanceof Candys)
            {
